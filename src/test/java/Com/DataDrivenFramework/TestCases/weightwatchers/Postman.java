...
public class Postman {
		 ...
		 //   WebDriver driver = new ChromeDriver();
		    ...
		    element = wait.until(ExpectedConditions.visibilityOfElementLocated((By.xpath("//*[@id="fhbjgbiflinjbdggehcddcbncdddomop"]/div/div/img"))));
		    driver.findElement(By.xpath("/html/body/div[6]/div[1]/div/div/div[2]/div[3]/div[1]/div/div/div[2]")).click();
		   
		  //*[@id="fhbjgbiflinjbdggehcddcbncdddomop"]/div/div/img
